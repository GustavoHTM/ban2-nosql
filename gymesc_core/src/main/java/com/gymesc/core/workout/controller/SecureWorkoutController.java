...
public class SecureWorkoutController {
    ...
    public ResponseEntity<Void> deleteWorkout(@PathVariable String workoutId) throws BusinessException {
    ...
    public ResponseEntity<WorkoutDTO> findById(@PathVariable String workoutId) throws BusinessException {
    ...
    @GetMapping
    public ResponseEntity<List<WorkoutDTO>> list(@RequestParam(required = false) String search) throws BusinessException {
        List<WorkoutDTO> workoutDTOList = this.workoutService.listByUser(search);
